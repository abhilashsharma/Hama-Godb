...
public class LongMapPartitionJSONReaderNonEdge<S extends Writable, V extends Writable, E extends Writable, K extends Writable, M extends Writable>
    implements
  ...
  public LongMapPartitionJSONReaderNonEdge(
  ...
  V vertexValue = (V) vertexMap;
    ...
    for (Object edgeInfo : edgeList) {
      ...
      //not materializing Edges attributes
