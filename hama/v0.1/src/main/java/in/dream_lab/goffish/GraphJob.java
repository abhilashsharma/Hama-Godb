...
public class GraphJob extends BSPJob {
  ...
  public GraphJob(HamaConfiguration conf, Class<? extends SubgraphComputeWrapup> exampleClass)
      throws IOException {
    super(conf); 
    ...
    conf.setClass(SUBGRAPH_COMPUTE_CLASS_ATTR, exampleClass, SubgraphComputeWrapup.class);
