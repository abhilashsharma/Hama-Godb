...
public class LongMapPartitionSubsetJsonReaderBackup<S extends Writable, V extends Writable, E extends Writable, K extends Writable, M extends Writable>
    implements
  ...
  public LongMapPartitionSubsetJsonReaderBackup(
  ...
  public static final Log LOG = LogFactory.getLog(LongMapPartitionSubsetJsonReaderBackup.class);
